...
const Cart = () => {
  ...
  return (
   <Box m="10% 10%">
     <Grid display={{base:"block",sm:"block",md:"block",lg:"flex",xl:"flex"}}  gridTemplateColumns={{base:"2fr,1fr",xl:"2fr 1fr"}} 
       className="checkout">
      <Box className="checkout__left">
        ...
        {state.basket.length === 0 ? (
          <Box>
            ...
            <NavLink to="/menu"><Center><button className='btn_pill' >Click me for Order Now</button></Center></NavLink>
            
            <Center><Image src={empty_bucket}/></Center>
          </Box>
        ) : (
          <Box>
