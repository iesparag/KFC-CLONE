...
const SingleCard = ({images,name,type,price,description}) => {
  return (
    // <Box   w="200px" h="200px">
      <GridItem   >
         ...
         <Box  >
          ...
          <button className='btn_pill' bg="#e4002b"><HStack><Text>Add to Cart</Text><Image src={Icon_Add_to_Cart} alt="bucket" /></HStack> </button>
